...
describe('MsgConnChatGptBotWorkerManager', () => {
  it('should get a random READY chatgpt bot worker', () => {
    ...
    manager.setStatus("0","2","2", MsgConnChatGptBotWorkerStatus.OFFLINE);
    manager.setStatus("1", "2","2", MsgConnChatGptBotWorkerStatus.BUSY);
    manager.setStatus("2","2","2",  MsgConnChatGptBotWorkerStatus.READY);
    manager.setStatus("3","2","2",  MsgConnChatGptBotWorkerStatus.READY);
    manager.setStatus("4", "2","2", MsgConnChatGptBotWorkerStatus.READY);
